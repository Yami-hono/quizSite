...
<div class="container">
	...
	?>
	<div><h2 style="color: white;">Course Name: <?php echo $val ?></h2>
		<form  action="addquestion.php" method="post">
		<input  name="course"" type="hidden" value="<?php echo $val; ?>">
		<input type="submit" class="button" value="Add Question"></form>
		<form action="delquestion.php" method="post">
		<input  name="course" type="hidden" value="<?php echo $val;?>">
		<input type="submit" class="button" value="Delete Question"></form>
	</div>
</div>
